    ...
    product && (
      <div className="mt-12 mb-10 ">
        ...
        <div className="flex flex-col items-center w-max ">
                ...
                <button onClick={()=>{navigate('/products') ; scrollTo(0,0)}}className="mx-zuto cursor-pointer px-12 my-16 py-2.5 border rounded text-primary hover:bg-primary/10 transition">
                    See More
                </button>
        </div>
      </div>
