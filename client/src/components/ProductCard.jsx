...
//                             <img className="md:w-3.5 w3" key={i} src={i<4 ? assets.star_icon :assets.star-dull_icon} alt="" />
...
const ProductCard = ({ product }) => {
    const [count, setCount] = React.useState(0);
    const { currency, addToCart, cartItems, removeFromcart } = useAppContext(); // Add missing destructured values
