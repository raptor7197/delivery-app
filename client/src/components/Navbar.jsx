    ...
    <div>
      <nav className="flex items-center justify-between px-6 md:px-16 lg:px-24 xl:px-32 py-4 border-b border-gray-300 bg-white relative transition-all">
        ...
        <div className="hidden sm:flex items-center gap-8">
          ...
          {!user ? (
            ...
            >
              ...
              />
              {profileDropdownOpen && (
                <ul className="absolute top-10 right-0 bg-white shadow-lg border border-gray-300 rounded-md text-sm z-40 w-32 p-2">
                  <li
                    onClick={() => {
                      navigate("/my-orders");
                      setProfileDropdownOpen(false);
        ...
        <div className="flex items-center gap-4 sm:hidden">
          ...
          >
            <img src={assets.nav_cart_icon} alt="cart" />
            <span className="absolute -top-2 -right-3 text-xs text-white bg-teal-500 w-[18px] h-[18px] rounded-full flex items-center justify-center">
              {getcartCount()}
            </span>
          </div>
        ...
        {open && (
          <div className="absolute top-[60px] left-0 w-full bg-white shadow-md py-4 flex flex-col items-center gap-2 px-5 text-sm sm:hidden z-50">
